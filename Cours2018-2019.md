...
Maintenant que vous avez téléchargé et installé tous les logiciels précédents , vous allez démarrez votre browser.  
Vous vous renderez sur le même site qu'avant depuis Tor pour vérifier que _votre adresse IP est masquée_.
